	...
	<body style="background-color:#333;">
	      ...
	      <div class="login">
          	<div class="login1">
                ...
                <?php
                echo form_open('auth_admin/login');
                ?>
                ...
                <input type="submit" class="kolom_submit_login" value="LOGIN ADMIN" name="submit"/>
                </form>
            
          </div>
          
          <div align="center" style="margin-top:100px;">
          <a href="<?= base_url("auth/login") ?>" style="text-decoration:none;color:#333;">user</a></div>
	</body>
</html>